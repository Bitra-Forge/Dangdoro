  ...
  return (
    ...
    >
      <div className="bg-zinc-900/80 backdrop-blur-3xl border border-white/10 rounded-2xl shadow-2xl relative overflow-visible h-full flex flex-col">
        ...
        <div className="max-h-[min(340px,calc(100dvh-12rem))] overflow-y-auto overflow-x-hidden px-12 -mx-12 pt-6 pb-6 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <div className="px-6">
