          ...
          return (
            <button
              ...
              className={cn(
                ...
                compact
                  ? "px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg text-[10px] sm:text-xs gap-1.5 sm:gap-2"
                  : "px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm gap-2 sm:gap-2.5",
                isActive
