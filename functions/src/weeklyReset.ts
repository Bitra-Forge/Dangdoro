...
export async function buildAllTimeLeaderboard(db: admin.firestore.Firestore) {
...
export async function buildWeeklyLeaderboard(db: admin.firestore.Firestore) {
...
export const weeklyReset = onSchedule("0 0 * * 5", async (event) => {
