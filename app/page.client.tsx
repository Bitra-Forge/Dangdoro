...
import { Clock, CheckCircle2 as CheckIcon, X as CloseIcon, ChevronDown, HelpCircle } from "lucide-react";
    ...
    if (!user || user.isAnonymous) {
      steps.push({
        ...
        popover: {
          ...
          description: "Guest progress is <span style=\"color: #ff5c53ff; font-weight: bold;\">temporary and automatically deleted after 24 hours</span>. Sign in to save your focus history permanently.",
          side: "bottom",
          align: "center",
        },
      });
