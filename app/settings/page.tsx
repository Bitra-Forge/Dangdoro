...
const DevAvatar = ({ name, avatar }: { name: string; avatar?: string }) => {
            ...
            <div className="relative z-10 w-full min-h-screen font-sans text-white">
                <main className="max-w-4xl mx-auto w-full px-6 pt-20 pb-20">
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Team Section */}
                        <section>
                            <h2 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-4 px-1">Meet the Team</h2>
                            <div className="bg-zinc-900/50 rounded-lg border border-white/5 divide-y divide-white/5 overflow-hidden">
                                {[
                                    {
                                        name: "Mohamed Elzalook",
                                        github: "http://github.com/Morales020",
                                        linkedin: "http://www.linkedin.com/in/mohamed-elzalook/",
                                        avatar: "https://avatars.githubusercontent.com/u/114666874?v=4"
                                    },
                                    {
                                        name: "Tamim Abdrabou",
                                        github: "https://github.com/TamemAbdRab0u",
                                        linkedin: "https://www.linkedin.com/in/tamem-abdrabou-34ab14357/",
                                        avatar: "https://avatars.githubusercontent.com/u/143705285?v=4"
                                    },
                                    {
                                        name: "Hossam Fathy",
                                        github: "https://github.com/finitemist",
                                        linkedin: "https://www.linkedin.com/in/hossam-fathy-bb1039259/",
                                        avatar: "https://avatars.githubusercontent.com/u/121311553?v=4"
                                    }
                                ].map((dev, i) => (
                                    <div key={i} className="flex items-center justify-between p-6 transition-colors hover:bg-white/[0.01]">
                                        <div className="flex items-center gap-4">
                                            <DevAvatar name={dev.name} avatar={dev.avatar} />
                                            <div className="flex flex-col">
                                                <span className="text-zinc-200 font-bold text-sm">{dev.name}</span>
                                                <span className="text-[10px] text-zinc-500 uppercase tracking-wider mt-0.5">Developer</span>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <a
